...
:init
@REM Decide the starting point
set MAVEN_CMD_LINE_ARGS=%*

@REM Find the project basedir
for %%F in ("%~dp0.") do set "MAVEN_PROJECTBASEDIR=%%~fF"

@REM Use the Maven Wrapper JAR
...
echo Please run the Maven Wrapper downloader first or set up Maven manually.
